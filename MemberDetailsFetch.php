...
while ($row = mysqli_fetch_array($result)) {
    ...
    $sub_array[] = '<div contenteditable class="update" data-id="'.$row["Color"].'" data-column="Color">' . $row["Color"] . '</div>';
    ...
    $sub_array[] = '<button type="button" name="view_data" class="btn btn-warning btn-xs view_data" id="'.$row["MemberID"].'">View Badge Detail</button>';
    $sub_array[] = '<button type="button" name="update_member" class="btn btn-danger btn-xs update_member" id="'.$row["MemberID"].'">Update Member</button>';
    // $sub_array[] = '<a href="MemberBadgeFetchSingle.php?success='.$row["MemberID"].'" class="btn btn-warning btn-xs view">View Badge Details</a>';
    // $sub_array[] = '<a href="MemberBadgeFetchSingle.php?update='.$row["MemberID"].'" class="btn btn-danger btn-xs update">Update Member</button>';
    $sub_array[] = '<button type="button" name="earnedbadge" class="btn btn-primary btn-xs earnedbadge" id="'.$row["MemberID"].'">Earned Badge</button>';
    $data[] = $sub_array;
}
