    ...
    <div class="col-lg-6 m-auto">
      ...
      <div class="card">
        <div class="card-title bg-dark rounded-top">
          <h5 class="text-center text-white py-3">Register as Member</h5>
        </div>
...
<!-- <input type="text" id="fname" class="form-control mb-2" placeholder="First Name" data-parsley-trigger="focusout" data-parsley-firstname data-parsley-firstname-message="Invalid Character"> -->
          <input type="text" id="member_name" class="form-control mb-2" name="member_name" placeholder="Full Name" required data-parsley-pattern="^[A-Z][a-z]+\s[A-Z][a-z]+$" data-parsley-trigger="focusout" data-parsley-pattern data-parsley-pattern-message="Must contain First and Last name beginning with a capital letter and seprate by a space">
          <input type="text" id="uname" class="form-control mb-2" name="uname" placeholder="Username" data-parsley-trigger="focusout" required data-parsley-username data-parsley-username-message="Username already Exists">
          ...
          <!-- <input type="password" id="access"class="form-control mb-2" name="Access" placeholder="Access Code" data-parsley-trigger="focusout"> -->
            ...
            <a href="memberlogin.php" class="btn btn-outline-primary mb-1">Back</a>                  
              <div class="form-inline float-right">
              <button id="submit" name="submit" class="btn btn-outline-primary">Register</button>
              </div>                        
          </form>
        </div>
  ...
  if($('#validate_form').parsley().isValid())
  {
   $.ajax({
    ...
    success:function(data)
    {
     ...
     $('#submit').val('Submit');
     window.location.href = 'memberlogin.php'; // want to post the data this in redirection
     alert(data);
    }
   });
  }
