    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select name='category' class="form-control mb-2" id="category" onChange="getBadge(this.value); getLevel(this.value);">
                ...
                <label>Badge</label>  
                <select name='badges' class="form-control mb-2" id="badges" >
